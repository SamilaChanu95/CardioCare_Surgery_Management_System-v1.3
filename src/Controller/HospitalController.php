...
class HospitalController extends AbstractController
{
    ...
    {
        return $this->render('hospital/hospital.html.twig', [
    ...
    /**
     * @Route("/add", name="hospital_add", methods={"GET","POST"})
     */
    public function new(Request $request): Response
    {
        $hospital = new Hospital();
        $form = $this->createForm(HospitalType::class, $hospital,['edit_mode' => false,]);
    ...
    {
        $form = $this->createForm(HospitalType::class, $hospital,['edit_mode' => true,]);
        $form->handleRequest($request);
