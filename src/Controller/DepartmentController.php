...
class DepartmentController extends AbstractController
{
    ...
    /**
     * @Route("/add", name="department_add", methods={"GET","POST"})
     */
    public function new(Request $request): Response
    {
        $department = new Department();
        $form = $this->createForm(DepartmentType::class, $department,['edit_mode' => false]);
    ...
    {
        $form = $this->createForm(DepartmentType::class, $department,['edit_mode' => true]);
        $form->handleRequest($request);
