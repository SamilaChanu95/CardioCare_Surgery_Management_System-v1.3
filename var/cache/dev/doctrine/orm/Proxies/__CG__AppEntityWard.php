 ...
 */
class Ward extends \App\Entity\Ward implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'WardName', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'nurses', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'doctors', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'consultants', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'technicians', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'Department', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'Unit', '' . "\0" . 'App\\Entity\\Ward' . "\0" . 'Hospital'];
        }
    ...
    public function getWardName(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWardName', []);

        return parent::getWardName();
    }

    /**
     * {@inheritDoc}
     */
    public function setWardName(string $WardName): \App\Entity\Ward
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWardName', [$WardName]);

        return parent::setWardName($WardName);
    }
     ...
     * {@inheritDoc}
     */
    public function addNurse(\App\Entity\Nurse $nurse): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function removeNurse(\App\Entity\Nurse $nurse): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function addDoctor(\App\Entity\Doctor $doctor): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function removeDoctor(\App\Entity\Doctor $doctor): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function addConsultant(\App\Entity\Consultant $consultant): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function removeConsultant(\App\Entity\Consultant $consultant): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function addTechnician(\App\Entity\Technician $technician): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function removeTechnician(\App\Entity\Technician $technician): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function setDepartment(?\App\Entity\Department $Department): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function setUnit(?\App\Entity\Unit $Unit): \App\Entity\Ward
    {
     ...
     * {@inheritDoc}
     */
    public function setHospital(?\App\Entity\Hospital $Hospital): \App\Entity\Ward
    {
