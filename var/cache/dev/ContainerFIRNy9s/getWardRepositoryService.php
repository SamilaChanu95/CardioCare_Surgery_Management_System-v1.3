...
// Returns the private 'App\Repository\WardRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\WardRepository.php';

return $this->privates['App\\Repository\\WardRepository'] = new \App\Repository\WardRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
