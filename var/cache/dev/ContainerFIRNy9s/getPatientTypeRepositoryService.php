...
// Returns the private 'App\Repository\PatientTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PatientTypeRepository.php';

return $this->privates['App\\Repository\\PatientTypeRepository'] = new \App\Repository\PatientTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
