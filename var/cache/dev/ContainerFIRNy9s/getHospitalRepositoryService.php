...
// Returns the private 'App\Repository\HospitalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\HospitalRepository.php';

return $this->privates['App\\Repository\\HospitalRepository'] = new \App\Repository\HospitalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
