...
return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner(($this->privates['hwi_oauth.http_client'] ?? $this->load('getHwiOauth_HttpClientService.php')), ($this->privates['security.http_utils'] ?? $this->getSecurity_HttpUtilsService()), ['client_id' => $this->getEnv('FB_ID'), 'client_secret' => $this->getEnv('FB_SECRET'), 'scope' => 'email', 'options' => ['display' => 'popup', 'auth_type' => 'rerequest', 'csrf' => true], 'paths' => []], 'facebook', ($this->privates['hwi_oauth.storage.session'] ?? $this->load('getHwiOauth_Storage_SessionService.php')));
