...
// Returns the private 'App\Repository\NurseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NurseRepository.php';

return $this->privates['App\\Repository\\NurseRepository'] = new \App\Repository\NurseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
