...
// Returns the private 'App\Repository\ConsultantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ConsultantRepository.php';

return $this->privates['App\\Repository\\ConsultantRepository'] = new \App\Repository\ConsultantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
