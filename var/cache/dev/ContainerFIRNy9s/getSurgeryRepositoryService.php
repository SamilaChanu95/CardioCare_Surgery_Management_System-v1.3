...
// Returns the private 'App\Repository\SurgeryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SurgeryRepository.php';

return $this->privates['App\\Repository\\SurgeryRepository'] = new \App\Repository\SurgeryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
