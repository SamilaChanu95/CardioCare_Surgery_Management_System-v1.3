...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    'App\\Repository\\ConsultantRepository' => ['privates', 'App\\Repository\\ConsultantRepository', 'getConsultantRepositoryService.php', true],
    'App\\Repository\\DepartmentRepository' => ['privates', 'App\\Repository\\DepartmentRepository', 'getDepartmentRepositoryService.php', true],
    'App\\Repository\\DoctorRepository' => ['privates', 'App\\Repository\\DoctorRepository', 'getDoctorRepositoryService.php', true],
    'App\\Repository\\HospitalRepository' => ['privates', 'App\\Repository\\HospitalRepository', 'getHospitalRepositoryService.php', true],
    'App\\Repository\\ICURepository' => ['privates', 'App\\Repository\\ICURepository', 'getICURepositoryService.php', true],
    'App\\Repository\\NurseRepository' => ['privates', 'App\\Repository\\NurseRepository', 'getNurseRepositoryService.php', true],
    'App\\Repository\\PatientRepository' => ['privates', 'App\\Repository\\PatientRepository', 'getPatientRepositoryService.php', true],
    'App\\Repository\\PatientTypeRepository' => ['privates', 'App\\Repository\\PatientTypeRepository', 'getPatientTypeRepositoryService.php', true],
    'App\\Repository\\SurgeryRepository' => ['privates', 'App\\Repository\\SurgeryRepository', 'getSurgeryRepositoryService.php', true],
    'App\\Repository\\TechnicianRepository' => ['privates', 'App\\Repository\\TechnicianRepository', 'getTechnicianRepositoryService.php', true],
    ...
    'App\\Repository\\WardRepository' => ['privates', 'App\\Repository\\WardRepository', 'getWardRepositoryService.php', true],
], [
    'App\\Repository\\ConsultantRepository' => '?',
    'App\\Repository\\DepartmentRepository' => '?',
    'App\\Repository\\DoctorRepository' => '?',
    'App\\Repository\\HospitalRepository' => '?',
    'App\\Repository\\ICURepository' => '?',
    'App\\Repository\\NurseRepository' => '?',
    'App\\Repository\\PatientRepository' => '?',
    'App\\Repository\\PatientTypeRepository' => '?',
    'App\\Repository\\SurgeryRepository' => '?',
    'App\\Repository\\TechnicianRepository' => '?',
