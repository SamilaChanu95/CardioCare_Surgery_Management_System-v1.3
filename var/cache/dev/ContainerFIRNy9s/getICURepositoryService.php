...
// Returns the private 'App\Repository\ICURepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ICURepository.php';

return $this->privates['App\\Repository\\ICURepository'] = new \App\Repository\ICURepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
