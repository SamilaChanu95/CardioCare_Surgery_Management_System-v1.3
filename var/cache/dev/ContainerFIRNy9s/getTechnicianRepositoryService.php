...
// Returns the private 'App\Repository\TechnicianRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TechnicianRepository.php';

return $this->privates['App\\Repository\\TechnicianRepository'] = new \App\Repository\TechnicianRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
