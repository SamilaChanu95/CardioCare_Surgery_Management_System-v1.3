...
class __TwigTemplate_647af19cbc91d2178664ec67d2940b759800a584e899b23e8cc099ccb45cc459 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"httplug-";
    ...
    <div class=\"httplug-messages\">
        <div class=\"httplug-message card\">
            ";
        // line 37
        $this->loadTemplate("@Httplug/http_message.html.twig", "@Httplug/stack.html.twig", 37)->display(twig_to_array(["data" => twig_get_attribute($this->env, $this->source, (isset($context["stack"]) || array_key_exists("stack", $context) ? $context["stack"] : (function () { throw new RuntimeError('Variable "stack" does not exist.', 37, $this->source); })()), "clientRequest", [], "any", false, false, false, 37), "header" => "Request"]));
        // line 38
        echo "        </div>
        <div class=\"httplug-message card\">
            ";
        // line 40
        $this->loadTemplate("@Httplug/http_message.html.twig", "@Httplug/stack.html.twig", 40)->display(twig_to_array(["data" => twig_get_attribute($this->env, $this->source, (isset($context["stack"]) || array_key_exists("stack", $context) ? $context["stack"] : (function () { throw new RuntimeError('Variable "stack" does not exist.', 40, $this->source); })()), "clientResponse", [], "any", false, false, false, 40), "header" => "Response"]));
        // line 41
        echo "        </div>
    </div>
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["profile"]) {
                ...
                <div class=\"httplug-messages\">
                    <div class=\"httplug-message\">
                        ";
                // line 49
                $this->loadTemplate("@Httplug/http_message.html.twig", "@Httplug/stack.html.twig", 49)->display(twig_to_array(["data" => twig_get_attribute($this->env, $this->source, $context["profile"], "request", [], "any", false, false, false, 49), "header" => "Request"]));
                // line 50
                echo "                    </div>
                    <div class=\"httplug-message\">
                        ";
                // line 52
                $this->loadTemplate("@Httplug/http_message.html.twig", "@Httplug/stack.html.twig", 52)->display(twig_to_array(["data" => twig_get_attribute($this->env, $this->source, $context["profile"], "response", [], "any", false, false, false, 52), "header" => "Response"]));
                // line 53
                echo "                    </div>
                </div>
                ";
...
";
        ...
        ";
            // line 64
            $this->loadTemplate("@Httplug/stack.html.twig", "@Httplug/stack.html.twig", 64)->display(twig_to_array(["collector" =>             // line 65
...
{% endfor %}
", "@Httplug/stack.html.twig", "E:\\Symfony\\CardioCare\\Version-1.2\\vendor\\php-http\\httplug-bundle\\src\\Resources\\views\\stack.html.twig");
    }
}
