...
class __TwigTemplate_635d7d6af767e869d0838f92e58482f99e489b69650766d506f122b7a66c1768 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        $this->loadTemplate("meta_data.html.twig", "department/show.html.twig", 8)->display($context);
        // line 9
        echo "        
    <!-- CSS Links -->
    ";
        // line 11
        $this->loadTemplate("css_part.html.twig", "department/show.html.twig", 11)->display($context);
        echo "  
    ...
    <body class=\"hold-transition sidebar-mini layout-fixed\">
        <div class=\"wrapper\">
            ...
            <nav class=\"main-header navbar navbar-expand navbar-white navbar-light\">
                ...
                ";
        // line 28
        $this->loadTemplate("search_form.html.twig", "department/show.html.twig", 28)->display($context);
        // line 29
        echo "        
                <!-- Right navbar links -->
                ";
        // line 31
        $this->loadTemplate("navbar_link_logout.html.twig", "department/show.html.twig", 31)->display($context);
        // line 32
        echo "
            </nav>
            <!-- /.navbar -->
            ...
            <aside class=\"main-sidebar sidebar-dark-primary elevation-4\">
                ...
                ";
        // line 39
        $this->loadTemplate("brand_logo.html.twig", "department/show.html.twig", 39)->display($context);
        // line 40
        echo "                <!-- Sidebar -->
                <div class=\"sidebar\">
        ...
        echo "                        </div>
                    ...
                    <!-- Sidebar Menu -->
                     ";
        // line 56
        $this->loadTemplate("department/sidebar.html.twig", "department/show.html.twig", 56)->display($context);
        // line 57
        echo "                    <!-- /.sidebar-menu -->
                </div>
                <!-- /.sidebar -->
            ...
            <div class=\"content-wrapper\">
                ...
                <div class=\"content-header\">                 
                    ";
        // line 65
        $this->loadTemplate("page_header_nav.html.twig", "department/show.html.twig", 65)->display($context);
        // line 66
        echo "    
        ...
        echo "\">";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["department"]) || array_key_exists("department", $context) ? $context["department"] : (function () { throw new RuntimeError('Variable "department" does not exist.', 82, $this->source); })()), "DepartmentName", [], "any", false, false, false, 82), "html", null, true);
        echo "</a></p></td>
                                    <td><p>";
        // line 83
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["department"]) || array_key_exists("department", $context) ? $context["department"] : (function () { throw new RuntimeError('Variable "department" does not exist.', 83, $this->source); })()), "hospital", [], "any", false, false, false, 83), "html", null, true);
        echo "</p></td>
        ...
        echo "\" class=\"price py-2 px-3\">Edit</a></p></td>
                                    <td>";
        // line 85
        echo twig_include($this->env, $context, "department/_delete_form.html.twig");
        echo "</td> 
                                </tr>           
                            </table> 
                            <a href=\"";
        ...
        echo "\">back to list</a>  
                    ...
                    ";
        // line 92
        $this->loadTemplate("footer.html.twig", "department/show.html.twig", 92)->display($context);
        // line 93
        echo "
                </div><!-- /.content-header -->    
            </div>
    ...
    ";
        // line 108
        $this->loadTemplate("js_part.html.twig", "department/show.html.twig", 108)->display($context);
        // line 109
        echo "
";
    ...
    {
        return array (  252 => 109,  250 => 108,  233 => 93,  231 => 92,  224 => 88,  218 => 85,  214 => 84,  210 => 83,  204 => 82,  186 => 67,  183 => 66,  181 => 65,  171 => 57,  169 => 56,  164 => 53,  158 => 51,  152 => 49,  150 => 48,  144 => 45,  137 => 40,  135 => 39,  126 => 32,  124 => 31,  120 => 29,  118 => 28,  98 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                ...
                <div class=\"content-header\">                 
                    ...
                    <section class=\"ftco-section\">
                        <div class=\"container\">
                            <table>                  
                                <tr class=\"table table-hover table-avatar table-valign-middle table-head-fixed table-responsive-xl\"> 
                                    <td><p><a href=\"{{ path('department_edit', {'id': department.id}) }}\">{{  department.DepartmentName }}</a></p></td>
                                    <td><p>{{  department.hospital }}</p></td>
                                    <td><p align=\"center\" class=\"button-custom pricing-entry\"><a href=\"{{ path('department_edit', {'id': department.id}) }}\" class=\"price py-2 px-3\">Edit</a></p></td>
                                    <td>{{ include('department/_delete_form.html.twig') }}</td> 
                                </tr>           
                            </table> 
...
{% endblock %}
", "department/show.html.twig", "E:\\Symfony\\CardioCare\\Version-1.2\\templates\\department\\show.html.twig");
    }
}
