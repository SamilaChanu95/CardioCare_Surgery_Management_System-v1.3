...
class __TwigTemplate_73b3631b7263c3588debca4ff0231bd5bdda00c2054abce92cbfefbf8c0addbf extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        $this->loadTemplate("meta_data.html.twig", "patient/show.html.twig", 8)->display($context);
        // line 9
        echo "        
    <!-- CSS Links -->
    ";
        // line 11
        $this->loadTemplate("css_part.html.twig", "patient/show.html.twig", 11)->display($context);
        echo "  
    ...
    <body class=\"hold-transition sidebar-mini layout-fixed\">
        <div class=\"wrapper\">
            ...
            <nav class=\"main-header navbar navbar-expand navbar-white navbar-light\">
                ...
                ";
        // line 28
        $this->loadTemplate("search_form.html.twig", "patient/show.html.twig", 28)->display($context);
        // line 29
        echo "        
                <!-- Right navbar links -->
                ";
        // line 31
        $this->loadTemplate("navbar_link_logout.html.twig", "patient/show.html.twig", 31)->display($context);
        // line 32
        echo "
            </nav>
            <!-- /.navbar -->
            ...
            <aside class=\"main-sidebar sidebar-dark-primary elevation-4\">
                ...
                ";
        // line 39
        $this->loadTemplate("brand_logo.html.twig", "patient/show.html.twig", 39)->display($context);
        // line 40
        echo "                <!-- Sidebar -->
                <div class=\"sidebar\">
        ...
        echo "                        </div>
                    ...
                    <!-- Sidebar Menu -->
                     ";
        // line 56
        $this->loadTemplate("patient/sidebar.html.twig", "patient/show.html.twig", 56)->display($context);
        // line 57
        echo "                    <!-- /.sidebar-menu -->
                </div>
                <!-- /.sidebar -->
            ...
            <div class=\"content-wrapper\">
                ...
                <div class=\"content-header\">                 
                    ";
        // line 65
        $this->loadTemplate("page_header_nav.html.twig", "patient/show.html.twig", 65)->display($context);
        // line 66
        echo "    
                        ...
                        <div class=\"container\">
                            <div class=\"row no-gutters slider-text align-items-center justify-content-center\">
                                <div class=\"col-md-9 ftco-animate text-center\">
                                    <h2 class=\"breadcrumb-item\"><b>Patient</b></h2>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class=\"container\">
                            <table>                  
                                <tr class=\"table table-hover table-avatar table-valign-middle table-head-fixed table-responsive-xl\"> 
                                    <td><p><a href=\"";
        // line 82
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("patient_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["patient"]) || array_key_exists("patient", $context) ? $context["patient"] : (function () { throw new RuntimeError('Variable "patient" does not exist.', 82, $this->source); })()), "id", [], "any", false, false, false, 82)]), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["patient"]) || array_key_exists("patient", $context) ? $context["patient"] : (function () { throw new RuntimeError('Variable "patient" does not exist.', 82, $this->source); })()), "pFirstName", [], "any", false, false, false, 82), "html", null, true);
        echo "</a></p></td>
                                    <td><p align=\"center\" class=\"button-custom pricing-entry\"><a href=\"";
        // line 83
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("patient_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["patient"]) || array_key_exists("patient", $context) ? $context["patient"] : (function () { throw new RuntimeError('Variable "patient" does not exist.', 83, $this->source); })()), "id", [], "any", false, false, false, 83)]), "html", null, true);
        ...
        echo "\">back to list</a>  
                    ...
                    ";
        // line 91
        $this->loadTemplate("footer.html.twig", "patient/show.html.twig", 91)->display($context);
        // line 92
        echo "
                </div><!-- /.content-header -->    
            </div>
    ...
    ";
        // line 107
        $this->loadTemplate("js_part.html.twig", "patient/show.html.twig", 107)->display($context);
        // line 108
        echo "
";
        ...
        <div class=\"wrapper\">
            ...
            <aside class=\"main-sidebar sidebar-dark-primary elevation-4\">
                ...
                <!-- Sidebar user panel (optional) -->
                    ...
                    <!-- Sidebar Menu -->
                     {% include \"patient/sidebar.html.twig\" %}
                    <!-- /.sidebar-menu -->
                </div>
                <!-- /.sidebar -->
            </aside>
                ...
                <div class=\"content-header\">                 
                    ...
                    <section class=\"ftco-section\">
                        <div class=\"container\">
                            <table>                  
                                <tr class=\"table table-hover table-avatar table-valign-middle table-head-fixed table-responsive-xl\"> 
                                    <td><p><a href=\"{{ path('patient_edit', {'id': patient.id}) }}\">{{  patient.pFirstName }}</a></p></td>
                                    <td><p align=\"center\" class=\"button-custom pricing-entry\"><a href=\"{{ path('patient_edit', {'id': patient.id}) }}\" class=\"price py-2 px-3\">Edit</a></p></td>
                                    <td>{{ include('patient/_delete_form.html.twig') }}</td> 
                                </tr>           
                            </table> 
                            <a href=\"{{ path('patients_list') }}\">back to list</a>  
                        </div>
                    </section>
...
{% endblock %}
", "patient/show.html.twig", "E:\\Symfony\\CardioCare\\Version-1.2\\templates\\patient\\show.html.twig");
    }
}
